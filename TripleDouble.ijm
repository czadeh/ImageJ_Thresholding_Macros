mainDir = getDirectory("Choose the Main Directory to PROCESS");

processDir(mainDir + "cor" + File.separator);
processDir(mainDir + "sag" + File.separator);
processDir(mainDir + "tra" + File.separator);
